...
// private final ExecutorService diagramExecutor =
...
// public void draw(CppFile headerFile, CppFile implFile, String methodName,
// WebView webView) {
// try {
...
// private String generateSequence(CppFile headerFile, CppFile implFile, String
// methodName) {
...
// translator.analyzeMethodCalls(implFile.getCode(), methodName);
...
// private void addMethodCallToSequence(StringBuilder sb, MethodCall call,
// String mainLifelineName) {
